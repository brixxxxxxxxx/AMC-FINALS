...
export default function App() {
  ...
  return (
    <ScrollView style={{backgroundColor: '#1c1c1c'}}>
      ...
      <Text style = {styles.paragraph2}>Hello, I'm Joshua Lenon, a skilled programmer with a passion for solving complex problems and optimizing system. Im currently a 3rd year student in Global Reciprocal Colleges. , I thrive on tackling challenges head-on and delivering innovative solutions that exceed expectations! So why wait you can hire me.</Text>
      <View style={{flexDirection: 'row'}}>
